...
//	+ 389 tiles (t|f reduced) not compressed
//	+ regular map (flat), not compressed, 32x24 
//	Total size: 512 + 24896 + 1536 = 26944
//
...
#define MenuDescriptionTilesLen 24896
extern const unsigned int MenuDescriptionTiles[6224];
